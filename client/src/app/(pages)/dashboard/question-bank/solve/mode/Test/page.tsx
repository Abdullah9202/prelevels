      ...
      <div className="flex flex-grow bg-gray-50">
        ...
        <h1 className="font-bold text-red-500">Logo</h1>
            <div className="mt-24 mb-40 flex space-y-2 flex-col mx-auto">
                ...
                <button className="hover:bg-[#F5D5D5] active:bg-[#F5D5D5] px-4 md:px-5 py-6 rounded-r-lg" aria-label="More options"  onClick={handleReportModelOpen}  >
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="red" className="bi bi-exclamation-triangle" viewBox="0 0 16 16">

...
@course_router.get("/", response={200: List[GetCourseDetailSchema], codes_4xx: dict}, auth=JWTAuth())
...
@course_router.get("/{username}/my-courses/", response={200: List[GetCourseDetailSchema], codes_4xx: dict}, auth=JWTAuth())

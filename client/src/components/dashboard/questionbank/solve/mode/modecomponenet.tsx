    ...
    <div className="flex-1 md:p-6 p-4 lg:py-7 py-4 bg-gray-100 md:mr-0 mx-auto">
      ...
      <div>
        ...
        <div className="flex justify-center items-center mt-3 space-x-6 text-white">
          <h1 className="px-6 py-2 text-3xl font-bold text-gray-800">Choose Mode</h1>
        </div>
        ...
        <div className="flex flex-col md:flex-row justify-center items-center mt-6 space-y-4 md:space-y-0 md:space-x-8">
          ...
          <div className="w-full max-w-xs h-96 bg-[#D9D9D9] rounded-lg shadow-md p-6 border-2 border-white ">
            <div className="flex items-center justify-center mb-4">
              <div >
                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="red" className="bi bi-calculator" viewBox="0 0 16 16">
            ...
            <h2 className="text-center text-xl font-semibold mb-2">Practice Mode</h2>
            <p className="text-gray-500 text-center mb-4">
              Practice mode is suitable for improving accuracy and time spent on each part.
            </p>
            <div className="text-center mb-4">
              <label className="block text-sm font-medium text-gray-700 mb-2">Choose the time limit:</label>
          ...
          <div className="w-full max-w-xs h-96 bg-[#D9D9D9] rounded-lg shadow-md p-6 border-2 border-white">
            <div className="flex items-center justify-center mb-4">
              <div className=" p-2 ">
                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="red" className="bi bi-clipboard-minus" viewBox="0 0 16 16">
            ...
            <h2 className="text-center text-xl font-semibold mb-2">Simulation Test Mode</h2>
            <p className="text-gray-500 text-center mb-4">
              Simulation test mode is the best option for experiencing the real test on computer.
            </p>

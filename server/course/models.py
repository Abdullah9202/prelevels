...
class Course(models.Model):
    ...
    course_image = models.ImageField(_("Course image"), upload_to=None, height_field=None, 
                                    width_field=None, max_length=None, null=False, blank=False)
    whtasapp_link = models.URLField(_("Whatsapp Link"), null=True)

  ...
  return (
    <section className="py-12 bg-gray-100">
      <div className="container mx-auto px-4">
        <h2 className="text-3xl font-bold text-start lg:px-14 mb-8">
          What We Offer
        </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:px-14">
          ...
          <div className="bg-[#D9D9D9] p-6 rounded-lg text-center border-2 border-white">
            ...
            <p className="text-gray-700 text-start text-sm">
              ...
              dashboard. Live exam link appears only when the exam is live.
            </p>
          </div>
          ...
          <div className="bg-[#D9D9D9] p-6 rounded-lg text-center border-2 border-white">
            ...
            <p className="text-gray-700 text-start text-sm">
              Dashboard is true sense that help you analyze your performance.
              Everything you do at one place.
            </p>
          </div>
        </div>
      </div>

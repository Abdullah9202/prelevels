    ...
    return (
        <div className="p-6 min-h-screen shadow-lg bg-white w-20">
            ...
            <div className="mt-24 -ml-5 flex space-y-2 flex-col">
                <button className="hover:bg-[#F5D5D5] active:bg-[#F5D5D5] px-8 py-6 rounded-r-lg" aria-label="Highlighter">
                ...
                <button className="hover:bg-[#F5D5D5] active:bg-[#F5D5D5] px-8 py-6 rounded-r-lg" aria-label="More options">
